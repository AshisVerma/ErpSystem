...
<div class="main-panel">
  ...
  <div class="page-header">
          ...
          <a href="<?php echo site_url('unit') ?> "><button class="btn btn-info" data-toggle="modal" data-target="#exampleModal">UNIT LIST</button></a>
          </div>
          ...
          <div class="row">
          	...
          	<div class="col-sm-12 col-lg-12 col-md-12">
          		<div class="card">
          			...
          			<div class="card-body">
          				 <form action="<?php echo site_url('unit/create') ?>" method="post">
         <div class="form-group">
           <label>UNIT NAME</label>
           <input type="text" name="name" placeholder="Unit Name" class="form-control"  value="<?=set_value('fee_group')?>">
