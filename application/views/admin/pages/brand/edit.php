...
<div class="main-panel">
  ...
  <div class="page-header">
          ...
          <a href="<?php echo site_url('brand/') ?> "><button class="btn btn-info" data-toggle="modal" data-target="#exampleModal">BACK</button></a>
          </div>
          	...
          	<div class="col-sm-12 col-lg-12 col-md-12">
          		<div class="card">
          			<div class="card-header bg-primary">
          				<h5 class="text-white" >UPDATE BRAND</h5>

          			</div>
          			<div class="card-body">
          				 <form action="<?php echo site_url('brand/update') ?>" method="post">
                    <input type="hidden" name="id" value="<?php echo $data[0]['id']?>">
         <div class="form-group">
           <label>BRAND NAME</label>
           <input type="text" name="name" placeholder="Brand Name" class="form-control" required="" value="<?php echo $data[0]['name']?>">
         ...
         <button class="btn btn-primary mb-0">UPDATE BRAND</button>
  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header bg-warning py-3">
        <h5 class="modal-title text-white" id="exampleModalLabel ">UPDATE BRAND</h5>
